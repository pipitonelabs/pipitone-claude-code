...
My personal Claude Code configuration for productive development. This plugin provides **14 slash commands** and **159 specialized AI agents** to supercharge your development workflow. This is based on [edmund-io](https://github.com/edmund-io/edmunds-claude-code) and [0xfurai's](https://github.com/0xfurai/claude-code-subagents) repos.
