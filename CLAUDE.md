...
1. **ALWAYS** create a feature branch **BEFORE** making any code changes:

   ```bash
   git checkout -b feature/(feature-name-or-bug-name)
   ```

2. Commit changes **REGULARLY** during development:
   - After switching between major steps/files/features
   - Use meaningful commit messages (Type: prefix)

3. **NEVER** work directly on main branches
